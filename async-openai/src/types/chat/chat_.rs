...
#[derive(Debug, Deserialize, Serialize, Clone, PartialEq, Default, ToSchema)]
...
pub struct ChatCompletionResponseMessage {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub content: Option<String>,
    /// Reasoning / chain-of-thought content (e.g. extracted from a `<think>` block),
    /// kept separate from the user-facing `content`. Populated by reasoning models
    /// such as GLM, DeepSeek-R1, and QwQ.
...
#[derive(Clone, Serialize, Default, Debug, Builder, Deserialize, PartialEq, ToSchema)]
...
#[derive(Clone, Serialize, Debug, Default, Deserialize, PartialEq, ToSchema)]
...
#[derive(Debug, Deserialize, Clone, PartialEq, Serialize, ToSchema)]
