...
pub struct NamespaceToolParam {
    /// The namespace name used in tool calls.
    pub name: String,
    /// A description of the namespace shown to the model.
    pub description: String,
    /// The function and custom tools available inside this namespace.
...
/// A function tool that can be used within a namespace.
#[derive(Debug, Serialize, Deserialize, Clone, PartialEq, Default, Builder, ToSchema)]
#[builder(
...
pub struct FunctionToolParam {
    ...
    /// Whether this function should be deferred and discovered through tool search.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct FunctionCallOutputItemParam {
    ...
    pub call_id: String,
    /// The namespace of the function that produced the output.
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CustomToolCallOutput {
    ...
    pub call_id: String,
    /// The namespace of the custom tool that produced the output.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub namespace: Option<String>,
...
pub struct CustomToolParam {
    ...
    /// Whether this tool should be deferred and discovered through tool search.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub defer_loading: Option<bool>,
}
...
pub struct OutputMessage {
    ...
    /// Labels this assistant message as intermediate commentary or the final answer.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub phase: Option<MessagePhase>,
